      ...
      <div className="bg-white border-b border-slate-100">
        <div className="container-default py-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-slate-500 mb-6">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Hosts</span>
          </nav>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="text-slate-600">
                Discover Jewish communities and organizations around the world
              </p>
            </div>
        ...
        {isLoading ? (
          ...
          <>
            <p className="text-slate-600 mb-6">
              Found <span className="font-semibold text-slate-900">{filteredCommunities.length}</span> hosts
            </p>
