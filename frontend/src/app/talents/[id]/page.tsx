...
export default function ArtistDetailPage({
  ...
  useEffect(() => {
    const fetchArtist = async () => {
      try {
        const response = await fetch(`${API_URL}/talents/${params.id}`);
        if (!response.ok) {
    ...
    return (
      <div className="min-h-screen bg-slate-50 pt-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Talent Not Found</h1>
          <p className="text-slate-600 mb-6">The talent you&apos;re looking for doesn&apos;t exist.</p>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                {artist.is_featured && (
                  <span className="badge-accent">Featured Talent</span>
                )}
              </div>
