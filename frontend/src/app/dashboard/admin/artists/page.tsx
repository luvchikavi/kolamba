...
export default function ArtistsPage() {
  ...
  return (
    <div className="p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900">Artist Management</h1>
        <p className="text-slate-500">Approve, manage, and feature artists</p>
      </div>
      ...
      {artists.length === 0 ? (
        <div className="card p-12 text-center">
          ...
          <p className="text-slate-500">
            {statusFilter
              ? `No ${statusFilter} artists match your search.`
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900">
                      {artist.name_en || artist.name_he || "Unnamed Artist"}
                    </h3>
