      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            {suggestion.communities.length} hosts
          </p>
        </div>
  ...
  return (
    <div className="card p-6">
      ...
      <div className="mt-4 flex items-center justify-between">
        <Link
          href={`/dashboard/talent/tours/${tour.id}`}
      ...
      <div className="relative bg-white rounded-2xl p-6 w-full max-w-lg mx-4 shadow-xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Announce your availability and let hosts invite you
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-500 mt-1">
              Hosts in this region will see your tour opportunity
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Hosts will see your price tier ($, $$, or $$$)
              </p>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
          ...
          <div>
            ...
            <textarea
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Tell hosts about this tour - what type of performances, special requirements, etc."
              rows={3}
              className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
            />
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
            ...
            <ul className="text-sm text-amber-700 space-y-1">
              <li>1. Your tour will be visible to hosts in the region</li>
              <li>2. Hosts can send you booking requests</li>
...
export default function ArtistDashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [bookingsRes, toursRes, suggestionsRes, tourDatesRes] = await Promise.all([
        ...
        fetch(`${API_URL}/talents/${profile.id}/tour-dates`, { headers }),
      ]);
  ...
  const handleAddTourDate = async (data: {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/talents/${artistId}/tour-dates`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleDeleteTourDate = async (tourDateId: number) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/talents/${artistId}/tour-dates/${tourDateId}`,
        {
          method: "DELETE",
        ...
        <div className="container-default py-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Talent Dashboard</h1>
            ...
            {suggestions.length === 0 ? (
              <div className="card p-8 text-center">
                ...
                <p className="text-slate-500">
                  When hosts in nearby areas show interest, we&apos;ll suggest tour routes for you.
                </p>
              </div>
            ) : (
            ...
            {tours.length === 0 ? (
              <div className="card p-8 text-center">
                ...
                <p className="text-slate-500 max-w-md mx-auto mb-6">
                  Announce your availability and let hosts invite you to perform.
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Shows you&apos;ve confirmed - nearby hosts will see these
                </p>
              </div>
              <button
            ...
            {tourDates.length === 0 ? (
              <div className="card p-8 text-center">
                ...
                <p className="text-slate-500 max-w-md mx-auto mb-6">
                  Add your confirmed shows so nearby hosts can find you.
