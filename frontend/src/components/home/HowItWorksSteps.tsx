...
const steps = [
  {
    ...
    icon: Search,
    title: "DISCOVER",
    description: "Browse our curated selection of Israeli artists. Filter by category, language, and availability to find the perfect match for your community.",
    color: "bg-teal-50",
  ...
  },
  {
    ...
    icon: Calendar,
    title: "BOOK",
    description: "Send a booking request with your event details. Artists respond directly, and Kolamba helps coordinate tours to reduce costs for everyone.",
    color: "bg-pink-50",
  ...
  },
  {
    ...
    icon: Sparkles,
    title: "EXPERIENCE",
    description: "Host an unforgettable cultural event. From concerts to workshops, bring Israeli culture to your community and create lasting connections.",
    color: "bg-amber-50",
