...
export const translations = {
  he: {
    ...
    bookingForm: {
      ...
      submit: 'שלח בקשה',
      submitting: 'שולח...',
      termsPrefix: 'בלחיצה על "שלח בקשה" אתה מסכים ל',
      termsLink: 'תנאי השימוש',
      fields: {
        date: 'תאריך מבוקש',
        location: 'מיקום ההופעה',
        budget: 'תקציב משוער (USD)',
        notes: 'פרטים נוספים',
      },
      placeholders: {
        location: 'עיר, מדינה',
        budget: 'הזן סכום',
        notes: 'ספר על הקהילה שלך, סוג האירוע, ציפיות מיוחדות...',
      },
      validation: {
        dateRequired: 'נא לבחור תאריך',
        dateFuture: 'נא לבחור תאריך עתידי',
        locationRequired: 'נא להזין מיקום (לפחות 3 תווים)',
        budgetPositive: 'נא להזין מספר חיובי',
        submitError: 'שגיאה בשליחת הבקשה. נסה שוב מאוחר יותר.',
      },
      success: {
        title: 'הבקשה נשלחה בהצלחה!',
        message: 'האמן {artist} יקבל את בקשתך ויחזור אליך בהקדם.',
  ...
  en: {
    ...
    bookingForm: {
      ...
      submit: 'Send Request',
      submitting: 'Sending...',
      termsPrefix: 'By clicking "Send Request" you agree to the',
      ...
      placeholders: {
        ...
        budget: 'Enter amount',
        notes: 'Tell us about your community, event type, special expectations...',
      },
      validation: {
        dateRequired: 'Please select a date',
        dateFuture: 'Please select a future date',
        locationRequired: 'Please enter location (at least 3 characters)',
        budgetPositive: 'Please enter a positive number',
        submitError: 'Error sending request. Please try again later.',
      },
      success: {
        title: 'Request Sent Successfully!',
        message: 'The artist {artist} will receive your request and get back to you soon.',
